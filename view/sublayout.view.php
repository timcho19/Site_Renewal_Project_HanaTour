...
<body>
  <header class="sub_header">
    <nav>
      ...
      <ul class="side-menus">
        ...
        <li class="hamburger-menu">
          <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="black" class="bi bi-list" viewBox="0 0 16 16">
    ...
    <aside>
        <div class="aside_top">
          <a href="login.php"> <img src="image/aside_login.png" alt="로그인"> 로그인</a>
